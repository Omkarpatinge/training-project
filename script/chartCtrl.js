...
define(['app', 'requestService', 'dataFactory', 'numberSuffix', 'apiConst'], function (app) {
	app.controller('chartCtrl', ['$scope', 'requestService', 'dataFactory', 'googleChartApiPromise', 'numberSuffixFilter', 'api', function ($scope, requestService, dataFactory, googleChartApiPromise, numberSuffixFilter, api) {
