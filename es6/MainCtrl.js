	    ...
	    scope.lists = [
	        {
	            ...
	            allowedTypes: ['dimensions'],
	            people: [
	                {name: "Time", type: 'dimensions',granularity:3600000,threshold:5,filterselect:false,filtertype:'Relative',filteroptions:[{startDate: '2017-08-09 07:51:02',endDate:'2017-08-19 07:51:02'}],filtersearch:'6H',clickok:false}
	            ]
	        },
	        {
	            label: "Split",
